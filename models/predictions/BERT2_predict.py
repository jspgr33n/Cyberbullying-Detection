...
model = BertForSequenceClassification.from_pretrained("../BERT2_trained")
tokenizer = BertTokenizer.from_pretrained("../BERT2_trained")
...
file_path = '../../data/test_data_updated_cyberbullying.csv' 
